...
*/
//function adding to parameters
//conver arguments to = numbers
//add function to return both parameters at the same time
//create a variable outse called called 'sum' and set it = to
//CODE HERE
function add(a, b) {
